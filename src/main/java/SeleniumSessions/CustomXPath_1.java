...
public class CustomXPath_1 {
	...
	By x1 = 	By.xpath("//input[@class='form-control private-form_control login-email')");//correct format
	By x2 = 	By.className("//input[@class='form-control private-form_control login-email");//wrong format
	By x3 = 	By.className("login_email");//correct format
	By x4 = 	By.className("form-control");//correct format
	

	
	//last column and last link on Amazon footer
	//((//div[@class='navFooterVerticalRow navAccessibility']//ul)[last()]//a)[last()]
	}
