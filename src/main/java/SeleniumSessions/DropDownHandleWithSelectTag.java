...
public class DropDownHandleWithSelectTag {
	...
	public static void main(String[] args) {
		...
		//drop down -- HTML tag of the drop down is selected
		//select class in selenium concept
...
//		// below selenium command is not reliabale as the value's position can be changed
//		//select.selectByIndex(5);
//		//below command is reliable
//		select.selectByVisibleText("India");
//		//below command is from the value attribute
